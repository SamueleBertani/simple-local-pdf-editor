...
function ToolBtn({ tool, icon: Icon, label, title, activeTool, orientation, onClick }: ToolBtnProps) {
    return (
        <button
...
export function Toolbar({ orientation = 'vertical' }: ToolbarProps) {
    ...
    return (
        <div className={cn(
            ...
            <ToolBtn tool="select" icon={MousePointer2} label="Select" title="Select (S)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
            <ToolBtn tool="handwriting" icon={Pen} label="Sign" title="Handwriting (H)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
            <ToolBtn tool="text" icon={Type} label="Text" title="Text (T)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
            <ToolBtn tool="rectangle" icon={Square} label="Cover" title="Cover (R)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
            <ToolBtn tool="image" icon={ImageIcon} label="Image" title="Image (I)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
            <ToolBtn tool="stamp" icon={Stamp} label="Stamp" title="Stamp (P)" activeTool={activeTool} orientation={orientation} onClick={handleToolClick} />
